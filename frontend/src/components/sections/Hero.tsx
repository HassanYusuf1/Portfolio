  ...
  return (
    <section id="home" className="relative min-h-screen bg-primary-gradient flex items-center text-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="animate-float delay-100 absolute top-1/4 left-1/4 w-3 h-3 rounded-full bg-white opacity-30"></div>
        <div className="animate-float delay-200 absolute top-1/3 right-1/4 w-4 h-4 rounded-full bg-white opacity-20"></div>
        <div className="animate-float delay-300 absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-white opacity-20"></div>
        <div className="animate-float delay-400 absolute bottom-1/3 right-1/3 w-5 h-5 rounded-full bg-white opacity-10"></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto md:mx-0">
          ...
          <div className="animate-fadeIn [animation-delay:200ms] mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fadeIn [animation-delay:300ms]">
